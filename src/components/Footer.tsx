    ...
    <footer className="bg-brand-dark text-white pt-16">
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <h3 className="font-heading font-bold text-2xl mb-4 text-brand-yellow">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-white/10 hover:bg-brand-red transition-colors p-2 rounded-full"
              >
                <Facebook size={20} />
              </a>
              <a 
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/order" className="text-gray-300 hover:text-white transition-colors">Order Online</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>Phone: +94 11 2345678</li>
              <li>Email: info@mrkottugrand.com</li>
              <li>WhatsApp: +94 77 1234567</li>
            </ul>
          </div>
